...
const UserAll = props => {
  ...
  const {title, mode, new_user, invite_courtship, invite_matchmaker, params, icon, item_labels, tabs, api} = props;
  ...
  return (
    <React.Fragment>
      <UserList
        ...
        new_user={new_user}
        invite_courtship={invite_courtship}
        invite_matchmaker={invite_matchmaker}
        tabs={tabs}
        api_get={api_get}
